...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    licenses.add(Licenses.fromGitHub("gabrielemariotti/changeloglib"));
    ...
    licenses.add(Licenses.fromGitHub("google/gson"));
    licenses.add(Licenses.fromGitHub("immutables/immutables"));
    licenses.add(
    ...
    licenses.add(Licenses.fromGitHub("realm/realm-java"));
    licenses.add(Licenses.fromGitHub("yqritc/RecyclerView-MultipleViewTypesAdapter"));
    licenses.add(Licenses.fromGitHub("ReactiveX/RxAndroid"));
    licenses.add(Licenses.fromGitHub("ReactiveX/RxJava"));
    ...
    licenses.add(Licenses.fromGitHub("twitter/twitter-text"));
